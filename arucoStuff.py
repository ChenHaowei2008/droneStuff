...
def detect_aruco_marker(image, marker_id):
    corners, ids, _ = aruco.ArucoDetector(aruco_dict, aruco_params).detectMarkers(image)
...
def draw_center_point(image, center_color=(0,0,255)):
    """
    Given an Image, returns the center of the image
